...
import { videos } from '../data/eventPhotographyVideos.js';
  ...
  return (
    <div className="category-page">
      ...
      <div className="breadcrumb">
        ...
        <span className="breadcrumb-separator">&gt;</span>
        <span className="breadcrumb-current">Event Photography</span>
      </div>

      <div className="category-header">
        <h1>Event Photography</h1>
        <p>Capturing unforgettable moments from special events</p>
      </div>
